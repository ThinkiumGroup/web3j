package org.thinkium.blockchain.web3j.abi.datatypes.generated;
...
public final class AbiTypes {
    ...
    public static Class<? extends Type> getType(String type, boolean primitives) {
        switch (type) {
            ...
            case "byte":
                return org.thinkium.blockchain.web3j.abi.datatypes.primitive.Byte.class;
            case "char":
                return Char.class;
            case "double":
                return org.thinkium.blockchain.web3j.abi.datatypes.primitive.Double.class;
            case "float":
                return org.thinkium.blockchain.web3j.abi.datatypes.primitive.Float.class;
            case "uint":
                return Uint.class;
            case "int":
                return primitives ? org.thinkium.blockchain.web3j.abi.datatypes.primitive.Int.class : Int.class;
            case "long":
                return org.thinkium.blockchain.web3j.abi.datatypes.primitive.Long.class;
            case "short":
                return org.thinkium.blockchain.web3j.abi.datatypes.primitive.Short.class;
            case "uint8":
                return Uint8.class;
            case "int8":
                return primitives ? org.thinkium.blockchain.web3j.abi.datatypes.primitive.Short.class : Int8.class;
            case "uint16":
            ...
            case "uint32":
                return primitives ? org.thinkium.blockchain.web3j.abi.datatypes.primitive.Long.class : Uint32.class;
            case "int32":
                return primitives ? Int.class : Int32.class;
            case "uint40":
                return primitives ? org.thinkium.blockchain.web3j.abi.datatypes.primitive.Long.class : Uint40.class;
            case "int40":
                return primitives ? org.thinkium.blockchain.web3j.abi.datatypes.primitive.Long.class : Int40.class;
            case "uint48":
                return primitives ? org.thinkium.blockchain.web3j.abi.datatypes.primitive.Long.class : Uint48.class;
            case "int48":
                return primitives ? org.thinkium.blockchain.web3j.abi.datatypes.primitive.Long.class : Int48.class;
            case "uint56":
                return primitives ? org.thinkium.blockchain.web3j.abi.datatypes.primitive.Long.class : Uint56.class;
            case "int56":
                return primitives ? org.thinkium.blockchain.web3j.abi.datatypes.primitive.Long.class : Int56.class;
            case "uint64":
                return Uint64.class;
            case "int64":
                return primitives ? org.thinkium.blockchain.web3j.abi.datatypes.primitive.Long.class : Int64.class;
            case "uint72":
                return Uint72.class;
            case "int72":
                return Int72.class;
